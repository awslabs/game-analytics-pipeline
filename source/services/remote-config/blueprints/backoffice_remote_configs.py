"""
This module contains backoffice remote_configs endpoints.
"""
...
backoffice_remote_configs_endpoints = Blueprint(
    "backoffice_remote_configs_endpoints", __name__
)


# @backoffice_remote_configs_endpoints.get("/")
...
@backoffice_remote_configs_endpoints.put("/<remote_config_ID>")
...
@backoffice_remote_configs_endpoints.delete("/<remote_config_ID>")
...
@backoffice_remote_configs_endpoints.post("/<remote_config_ID>/activate")
...
@backoffice_remote_configs_endpoints.post("/<remote_config_ID>/abtest")
...
@backoffice_remote_configs_endpoints.delete("/abtests/<abtest_ID>")
...
@backoffice_remote_configs_endpoints.post("/abtests/<abtest_ID>/activate")
...
@backoffice_remote_configs_endpoints.post("/abtests/<abtest_ID>/pause")
...
@backoffice_remote_configs_endpoints.post("/abtests/<abtest_ID>/promote")
